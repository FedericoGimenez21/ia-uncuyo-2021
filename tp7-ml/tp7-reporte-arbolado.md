A)1) Eliminé las variables/columnas "ultima_modificacion" "lat" "long" "area_seccion"  para el data_train y para el test, ya que consideré que no serian un buen aporte al analisis del problema. 
